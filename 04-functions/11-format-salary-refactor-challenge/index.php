...
// change formatSalary function fo arrow function
...
function calculateAverageSalary($listings, $formatSalary)
{
  ...
  // define the scope of variable as global inside the fxn to make the fxn `$formatSalary` work inside this fxns
  // global $formatSalary;
  // Another way to pass it to this fxn is to pass as a parameter 
